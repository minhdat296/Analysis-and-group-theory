\section{Finite groups}
    ...
    \subsection{Solvability, simplicity, and some finite Galois theory}
        \begin{definition}[Solvable groups] \label{def: solvable_groups}
            
        \end{definition}

        \begin{definition}[Simple groups] \label{def: simple_groups}
        ...
        \end{lemma}
            ...
            \end{proof}
        \begin{theorem}[Solvability of finite Galois groups] \label{theorem: solvability_of_finite_galois_groups}
